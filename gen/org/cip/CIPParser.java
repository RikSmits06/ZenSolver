...
public class CIPParser extends Parser {
	...
	public static class KnowledgeBaseContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(CIPParser.EOF, 0); }
	...
	@SuppressWarnings("CheckReturnValue")
	public static class LeStmtContext extends StatementContext {
		public TerminalNode VARIABLE() { return getToken(CIPParser.VARIABLE, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public LeStmtContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CIPListener ) ((CIPListener)listener).enterLeStmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CIPListener ) ((CIPListener)listener).exitLeStmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CIPVisitor ) return ((CIPVisitor<? extends T>)visitor).visitLeStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	public static class DeclStmtContext extends StatementContext {
		public List<TerminalNode> VARIABLE() { return getTokens(CIPParser.VARIABLE); }
		public TerminalNode VARIABLE(int i) {
			return getToken(CIPParser.VARIABLE, i);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class GeStmtContext extends StatementContext {
		public TerminalNode VARIABLE() { return getToken(CIPParser.VARIABLE, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public GeStmtContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CIPListener ) ((CIPListener)listener).enterGeStmt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CIPListener ) ((CIPListener)listener).exitGeStmt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CIPVisitor ) return ((CIPVisitor<? extends T>)visitor).visitGeStmt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				break;
			case 2:
				_localctx = new GeStmtContext(_localctx);
				...
				break;
			case 3:
				_localctx = new LeStmtContext(_localctx);
